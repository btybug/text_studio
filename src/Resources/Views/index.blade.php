    ...
    <section class="container-fluid">
        <div class="row " id="builderContain">
            <div class="col-xs-12 col-sm-6 previewAray" class="text-center">
                ...
                <textarea name="json_data" class="form-control hide" data-export="json" hidden="hidden"
                          style="margin-top:100px">{"css":{"font-size":"41px","text-shadow":"2px 2px 0px #ff0000, -2px 2px 0px #fc0000, 2px -2px 0px #ff0000, -2px -2px 0px #ff0000, 0px 0px 15px #000000","color":"#ffffff"},"textShadow":{},"class":"classname","savedcss":".classname{font-size:41px; text-shadow:2px 2px 0px #ff0000, -2px 2px 0px #fc0000, 2px -2px 0px #ff0000, -2px -2px 0px #ff0000, 0px 0px 15px #000000; color:#ffffff; }","classname":".classname"}</textarea>
...
{!! BBstyle(studio_path('text_studios/src/Resources/assets/css/text-studio.css')) !!}
{!! BBscript(studio_path('text_studios/src/Resources/assets/js/class-text-builder.js')) !!}
